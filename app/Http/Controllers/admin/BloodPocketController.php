...
class BloodPocketController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.bloodpockets.index', compact('bloodpockets'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.bloodpockets.create', compact('bloodbanks'));
    }
    ...
    public function edit($id)
    {
        try {
            ...
            return view('admin.bloodpockets.edit', compact('bloodpocket', 'bloodbanks'));
        } catch(\Exception $e) {
            return back();
        }
    }
