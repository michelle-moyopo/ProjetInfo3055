                        ...
                        <div class="card-body">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('responsable.bloodpocket.index') }}">{{ __('messages.bloodbanks') }}</a></li>
                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>
                                <a href="{{ route('responsable.bloodpocket.index') }}" class="btn btn-primary">{{ __('messages.back') }}</a>
                            </h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('responsable.bloodpocket.update', $bloodpocket->id) }}" method="POST">
                                @csrf
                                @method('PUT')
