                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>
                                <a href="{{ route('user.demander.index') }}" class="btn btn-primary">{{ __('messages.back') }}</a>
                            </h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('user.demander.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="form-group" hidden>
                                    <input type="text" name="type" value="DEMANDE" class="form-control" required>
