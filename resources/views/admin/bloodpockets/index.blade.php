                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="float-right">
                                <a href="{{ route('admin.bloodpocket.create') }}" class="btn btn-primary">{{ __('messages.add') }}</a>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-striped" id="table-2">
                                    ...
                                    @foreach($bloodpockets as $bloodpocket)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-outline-primary" href="{{ route('admin.bloodpocket.edit', $bloodpocket->id) }}" >
                                                ...
                                                <form id="delete-form" action="{{ route('admin.bloodpocket.destroy', $bloodpocket->id) }}" method="POST" class="d-none">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </td>
